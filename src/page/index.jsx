        ...
        <div className='relative w-1/3 h-5/6 bg-white rounded-lg'>
            ...
            <div className='absolute w-full flex flex-col justify-center items-center top-32'>
                ...
                <div className='flex flex-col justify-center items-center pt-6'>
                    <span className='font-league text-2xl font-medium text-[#250002]'>Yunus Dermawan</span>
                </div>
                ...
                <div className='flex items-center gap-3 pt-6 pb-4'>
                    <span className='text-xl font-semibold text-[#8F6241]'>Web Developer</span>
                </div>
                <div className='w-full flex justify-between px-16 pt-6 pb-8'>
                  <ReactWhatsapp number='6281359973044'>
